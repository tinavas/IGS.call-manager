		        		...
		        		<div class="frm_inputs">
		        			<table class="form_tbl">
			        			...
			        			<tr id="sub_dispo_24">
			        				...
			        				<td><?php echo form_dropdown('sub_disposition_id',$dropdown['sub_dispositions_24'],set_value('sub_disposition_id')); ?></td>
			        			</tr>
			        			<tr id="sub_dispo_2">
			        				<td>Sub-Disposition:</td>
			        				<td><?php echo form_dropdown('sub_disposition_id',$dropdown['sub_dispositions_2'],set_value('sub_disposition_id')); ?></td>
			        			</tr>
			        			<tr>
			        				<td>Flag Reason:</td>
